...
def objective_function(x):
    # Ví dụ: hàm Sphere (tối ưu Minimize)
...
# --- Lớp ABC ---
class ABC:
    def __init__(self, func, bounds, pop_size=10, max_iter=500, limit=50):
        self.func = func
        self.bounds = bounds
    ...
    # Tạo neighbor dựa trên cá thể khác
    ...
    # Tính xác suất cho Onlooker bee
    def calculate_probabilities(self):
        inv_fitness = [1/(f.fitness+1e-10) for f in self.population]
...
if __name__ == "__main__":
    bounds = [(-5, 5), (-5, 5)]  # Bài toán 2 biến
